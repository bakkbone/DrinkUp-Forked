...
namespace KitchenDrinksMod.Smoothie
{
    public abstract class BaseSmoothie : CustomItemGroup<BlenderCupItemGroupView>, IColorblindLabelPositionOverride, IColorblindLabelVisibilityOverride, IColorblindLabelSizeOverride
    {
        ...
        public override void SetupPrefab(GameObject prefab)
        {
            ...
            // Liquid
            // Liquid/Liquid2 already carry the correct material directly on the prefab
            // (see drinkup_smoothie_liquid.mat) - applying it again here by name string
            // is unreliable at runtime and was overwriting it with a broken lookup.
    ...
    public class BlenderCupItemGroupView : ItemGroupView, IItemSpecificView
    {
        ...
        public override void PerformUpdate(int item_id, ItemList components, bool is_order = false)
        {
            ...
            else
            {
                ...
                Material mat = new(smallLiquidRenderer.sharedMaterial);
                mat.SetColor("_Color0", finalColor);
